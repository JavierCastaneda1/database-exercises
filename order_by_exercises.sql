...
SELECT first_name, last_name FROM employees WHERE employees.first_name IN('Irena','Vidya','Maya') ORDER BY first_name, last_name;
...
SELECT emp_no, last_name FROM employees WHERE last_name LIKE 'E%' ORDER BY emp_no DESC;
