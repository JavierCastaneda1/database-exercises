USE codeup_test_db;
    ...
    INSERT INTO albums(artist, album_name, release_date, sales, genre)
        VALUES('Michael Jackson', 'Thriller', 1982, 49.2, 'Pop, Post-Disco, Funk, Rock'),
               ...
               ('Shania Twain', 'Come On Over', 1978, 14.4, 'Country, Pop'),
               ('Various Artist', 'Grease: The Original Soundtrack from the Motion Picture', 1992, 32.4, 'Rock and Roll'),
               ...
               ('Michael Jackson', 'Dangerous', 1991, 17.0, 'R&B, New Jack Swing, Pop'),
